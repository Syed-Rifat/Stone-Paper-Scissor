...
public class OfflinePlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_play); // Make sure to reference the correct layout
    ...
    private void resetScores() {
        ...
        compScore = 0;
        updateScoreboard();
        msgTextView.setText(R.string.play_your_move); // Make sure this string exists in your strings.xml
    }
}
